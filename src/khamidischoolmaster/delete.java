...
public class delete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("You are About to Delete a User!!");
        ...
        jusername2.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon("C:\\Users\\Malala\\Documents\\NetBeansProjects\\KhamidiSchoolMaster\\src\\khamidischoolmaster\\delete11.png")); // NOI18N
...
// TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String username2 = jusername2.getText();
        Connection conn  = null;

        PreparedStatement stm = null;
        if (!username.equals(username2)) {
            JOptionPane.showMessageDialog(null, "The username(s) you entered are not similar ", "Deletion failed!!", JOptionPane.ERROR_MESSAGE);
        } else {
            try {
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/system", "root", "");

                stm = conn.prepareStatement("DELETE from users where username = ? ");
                stm.setString(1, username);
                stm.executeUpdate();
                JOptionPane.showMessageDialog(null, "User Deleted Succussfully ");
                //, "Deletion successful", JOptionPane.ERROR_MESSAGE);
                jusername.setText(null);
                jusername2.setText(null);
                //stm.executeQuery("insert into users (username ,emailaddress , password ,usertype ) values ("+ username+ ","+ email+ ","+ password+  "+ 2 +)"); 
            } catch (SQLException e) {
JOptionPane.showMessageDialog(null, "Deletion NOT successfull ", "Deletion failed!!", JOptionPane.ERROR_MESSAGE);
